...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const t = {
    hi: {
      ...
      subtitleRegister: '🎁 ₹10 का मुफ्त साइनअप बोनस सीधे आपके विथड्रॉल वॉलेट में मिलेगा!',
      ...
      refBonusText: '✓ 5-लेवल लाइफटाइम कमीशन नेटवर्क से जुड़ें (7.8%)',
      loginBtn: 'आईडी व पासवर्ड से लॉगिन करें',
      registerBtn: 'खाता बनाएं व ₹10 फ्री बोनस पाएं 🎁',
      useOtpLogin: '📱 ओटीपी से लॉगिन करें',
      usePasswordLogin: '🔑 पासवर्ड से लॉगिन करें',
      haveAccount: 'पहले से रजिस्टर हैं? यहाँ लॉगिन करें',
      noAccount: 'नया यूजर? यहाँ क्लिक करके पहले रजिस्टर करें (फ्री ₹10 बोनस)',
      welcomeBonusPill: '🎁 रजिस्टर करें और पाएं ₹10 फ्री विथड्रॉल बोनस!',
    ...
    en: {
      ...
      subtitleRegister: '🎁 Get ₹10 Free Cash instantly added into your withdrawal wallet!',
      ...
      refBonusText: '✓ Connect to 5-level commission network (7.8%)',
      loginBtn: 'Sign In with ID & Password',
      registerBtn: 'Register & Claim ₹10 Free Bonus 🎁',
      useOtpLogin: '📱 Sign in with OTP',
      usePasswordLogin: '🔑 Sign in with Password',
      haveAccount: 'Already registered? Sign In',
      noAccount: "Don't have an account? Register Now (Free ₹10 Bonus)",
      welcomeBonusPill: '🎁 Register & Get ₹10 Free Withdrawal Bonus!',
